...
public class LabelServiceInvoker {
	...
	private void showLabelUI(String xmlFilePath, String processedXMLFilePath, String pdfPath, String httpUrl) {
		LabelPrinterController labelPrinterController = new LabelPrinterController(xmlFilePath, processedXMLFilePath, pdfPath, httpUrl);
