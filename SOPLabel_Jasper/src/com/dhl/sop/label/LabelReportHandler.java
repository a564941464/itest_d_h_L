...
public class LabelReportHandler {
	...
	public static void main(String[] args) {		
			...
			*/
			String XMLFilePath = "TransformXMLtoPDF/RequestXML/";
			String processedXMLFilePath = "TransformXMLtoPDF/ProcessedXMLS/"; 
			String pdfPath = "TransformXMLtoPDF/PDFReports/"; 
			File xmlFile = new File(XMLFilePath);
			...
			System.out.println(xmlFileList==null);
